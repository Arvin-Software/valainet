...
<div class="container-fluid" style="margin-top: 10%;">
     <div class="row">
        ...
        <div class="text-left" style="margin-left: 22%;">
            ...
            <p>CPU: Intel Xeon CPU or AMD Equivalent</p>
            <p>RAM: 16 GB or More</p>
            <p>Network: 100 Mbps or more</p>
            <p>Storage: 2TB or more</p><br>
        </div>
        <a href="index.php" class="btn btn-dark bor-ten float-left">&lt; Previous</a>
        <a href="../classes/dbOper.php" class="btn btn-dark bor-ten float-right">Next &gt;</a>
        </div>
        <div class="col-sm-4"></div>
     </div>